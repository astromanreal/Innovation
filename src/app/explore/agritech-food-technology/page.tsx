...
export default function AgritechFoodTechnologyPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 md:py-12 space-y-12 md:space-y-16">
      ...
      <Section title="Explore Further: Resources & Learning" titleIcon={<BookOpen className="w-6 h-6 text-primary"/>} description="Curated resources to deepen your understanding of Agritech & Food Technology." className="bg-muted/30">
