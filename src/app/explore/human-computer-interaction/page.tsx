...
import {
  ...
  MicVocal, MousePointerSquare as TactileIcon, BrainCircuit, Gamepad2, HeartPulse, Laptop, VrHeadset, Wand2, Share2, LockKeyhole, Accessibility, UsersRound, MessageSquareWarning,
...
const presentApplicationsData = [
  ...
  },
  {
    ...
    icon: <VrHeadset className="w-7 h-7 text-primary" />,
...
const keyPlayersData = {
  industryLeaders: [
    ...
    { name: 'Meta', focus: 'Quest VR headsets, AR research, haptic feedback technologies (Reality Labs).', icon: <VrHeadset className="w-5 h-5 text-primary"/> },
  ],
